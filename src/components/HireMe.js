...
const HireMe = () => {
  return (
    <div className="fixed left-1 bottom-[-50px] lg:bottom-[0px] flex items-center justify-center overflow-hidden md:-top-36 md:bottom-auto md:right-1 md:left-auto">
